...
class SmoothGradient(SaliencyInterpreter):
    ...
    Registed as a 'SaliencyInterpreter' with name "smooth-gradient"
    """
    def __init__(self, model, criterion, tokenizer, stdev=0.01, num_samples=20, show_progress=True, **kwargs):
