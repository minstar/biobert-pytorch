...
from input_marginalization import InputMarginalization
...
class DataTrainingArguments:
    ...
    adversarial_attack: str = field(
        default='hotflip',
        metadata={"help" : "Adversarial attack with hotflip, input reduction, and input marginalization"}
    )
...
def main():
    ...
    if data_args.adversarial_attack == 'hotflip':
        adversarial = Hotflip(
            model,
            criterion,
            tokenizer,
    ...
    elif data_args.adversarial_attack == 'input_marginalization':
        adversarial = InputMarginalization(
            model,
            criterion,
            tokenizer,
            show_progress=True,
    ...
    elif data_args.adversarial_attack == 'input_reduction':
        adversarial = InputReduction(
            model,
            criterion,
            tokenizer,
            show_progress=True,
    ...
    results = {}
    if training_args.do_eval:
        logger.info("*** Adversarial attack on Evaluation Set***")
    ...
    # if training_args.do_predict:
    #     logger.info("*** Adversarial attack on Test Set***")
        
    #     instances = adversarial.adversarial_attack(test_dataset)
        # if not os.path.exists(training_args.output_dir):
        #     os.makedirs(training_args.output_dir)
